...
//        engine = new GameEngine(players, 3);
//    }
//
//    @Test
...
//        when(curve.getXPosition()).thenReturn(GameEngine.SCREEN_WIDTH + 1);
...
//        verify(g, times(1)).fillRect(682, 3, 115, GameEngine.SCREEN_HEIGHT);
